...
import { deleteObject, getStorage, StorageReference, uploadString } from "firebase/storage";
...
export const uploadFile = (storageRef: StorageReference, file: string | null) => {
  if (file === null) {
